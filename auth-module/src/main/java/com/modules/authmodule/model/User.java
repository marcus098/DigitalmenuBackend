...
public class User implements UserDetails {
    ...
    @Column(name="general_confirmed")
    private boolean generalConfirmed;
    ...
    public User(String username, String name, String surname, String email, String password, Role role, Long idAgency, String phoneNumber, String otpConfirmEmail, String otpConfirmNumber, boolean generalConfirmed) {
        ...
        this.generalConfirmed = generalConfirmed;
    }

    public boolean isGeneralConfirmed() {
        return generalConfirmed;
    }

    public void setGeneralConfirmed(boolean generalConfirmed) {
        this.generalConfirmed = generalConfirmed;
    }
